 ...
 */
final class Version20220615170330 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD unitee_id INT NOT NULL');
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC27D3EB8572 FOREIGN KEY (unitee_id) REFERENCES unitee_produit (id)');
        $this->addSql('CREATE INDEX IDX_29A5EC27D3EB8572 ON produit (unitee_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_29A5EC27D3EB8572 ON produit');
        $this->addSql('ALTER TABLE produit DROP unitee_id');
    }
}
