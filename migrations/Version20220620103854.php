 ...
 */
final class Version20220620103854 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE production (id INT AUTO_INCREMENT NOT NULL, professeur_id INT NOT NULL, atelier_id INT NOT NULL, classe_id INT NOT NULL, destruction_id INT DEFAULT NULL, transfert_id INT DEFAULT NULL, produit_id INT DEFAULT NULL, temperature DOUBLE PRECISION NOT NULL, date_fabrication DATE NOT NULL, date_peremption DATE NOT NULL, quantite DOUBLE PRECISION NOT NULL, conditionnement DOUBLE PRECISION NOT NULL, INDEX IDX_D3EDB1E0BAB22EE9 (professeur_id), INDEX IDX_D3EDB1E082E2CF35 (atelier_id), INDEX IDX_D3EDB1E08F5EA509 (classe_id), INDEX IDX_D3EDB1E03292C08E (destruction_id), INDEX IDX_D3EDB1E03C9C4BAD (transfert_id), INDEX IDX_D3EDB1E0F347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
